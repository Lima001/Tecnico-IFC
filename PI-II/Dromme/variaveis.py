...
valor_evolucao_vida = 150
preco_incremento_municao = 200 
incremento_municao = 100
...
tela_velocidade = 5
titulo_tela = "Dromme"
icone_tela = "zumbi.png"
objeto_tela = Tela(tamanho_tela[0],tamanho_tela[1],tela_pos_x,tela_pos_y,tela_velocidade,objeto_mira,icone_tela,titulo_tela)
...
arma_scar = Arma(0,0,tamanho_arma,tamanho_arma,"scar.png",True,80,30,30,tiro2,"lendaria",60,"scar_lateral.png",3000,False)
arma_ak = Arma(0,0,tamanho_arma,tamanho_arma,"ak.png",True,40,30,30,tiro2,"rara",60,"ak1_lateral.png",500,False)
arma_deagle = Arma(0,0,tamanho_arma,tamanho_arma,"deagle.png",True,100,7,7,tiro1,"epica",21,"deagle_lateral.png",1500,False)
arma_m16 = Arma(0,0,tamanho_arma,tamanho_arma,"m16.png",True,60,30,30,tiro2,"epica",60,"m16_lateral.png",2000,False)
arma_uzi = Arma(0,0,tamanho_arma,tamanho_arma,"uzi.png",True,20,25,25,tiro2,"rara",75,"uzi1.png",0,True)
arma_pistola = Arma(0,0,tamanho_arma,tamanho_arma,"pistola.png",True,10,14,14,tiro1,"comum",300,"pistola_lateral.png",0,None) 

arma_pistola.texto = "Fixo"
arma_uzi.texto = "Selecionado"
