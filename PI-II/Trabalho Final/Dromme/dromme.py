...
class Pagina:
    ...
    def rodar_pagina(self):
        pygame.display.set_icon(pygame.image.load(variaveis.icone_tela))
        pygame.display.set_caption(variaveis.titulo_tela)
...
def executar_menu_principal(null=None):
    pagina = Pagina((0,0,0))
    objetos = [Botao_texto("Jogar",20,350,140,70,"bebas.ttf",5,pagina,jogo.avancar_fase),
    Botao_texto("Loja",20,430,100,70,"bebas.ttf",5,pagina,executar_loja_pg0,True),
    Botao_texto("Sobre",20,510,140,70,"bebas.ttf",5,pagina,executar_sobre,True),
    Botao_texto("Sair",680,510,100,70,"bebas.ttf",5,pagina,sair),
...
def executar_loja_pg0(menu):
    ...
    Botao_texto("Anterior",220,450,130,40,"bebas.ttf",5,pagina,passar),
    Botao_texto("Proximo",410,450,130,40,"bebas.ttf",5,pagina,executar_loja_pg1,menu),
    Botao_texto("Detalhes",640,20,130,40,"bebas.ttf",5,pagina,detalhe_loja0,menu),
...
def executar_loja_pg1(menu):
    ...
    Botao_texto("Proximo",410,450,130,40,"bebas.ttf",5,pagina,executar_loja_pg2,menu),
    Botao_texto("Detalhes",640,20,130,40,"bebas.ttf",5,pagina,detalhe_loja1,menu),
    Texto(str(variaveis.dinheiro),35,15,40,40,"bebas.ttf",pagina,(0,255,0))]
    if menu==True:
        objetos.append(Botao_texto("Voltar",20,520,150,60,"bebas.ttf",5,pagina,executar_menu_principal))
    else:
...
def executar_loja_pg2(menu):
    ...
    Botao_imagem(variaveis.imagem_kit,100,170,67,67,10,pagina,comprar_incremento_vida,menu),
    Botao_imagem(variaveis.imagem_municao,365,170,67,67,10,pagina,comprar_incremento_municao,menu),
    ...
    Botao_texto("Proximo",410,450,130,40,"bebas.ttf",5,pagina,executar_loja_pg3,menu),
    Botao_texto("Detalhes",640,20,130,40,"bebas.ttf",5,pagina,detalhe_loja2,menu),
    Texto(str(variaveis.dinheiro),35,15,40,40,"bebas.ttf",pagina,(0,255,0))]
    if menu==True:
        objetos.append(Botao_texto("Voltar",20,520,150,60,"bebas.ttf",5,pagina,executar_menu_principal))
    else:
...
def executar_loja_pg3(menu):
    ...
    Botao_texto("Proximo",410,450,130,40,"bebas.ttf",5,pagina,executar_loja_pg4,menu),
    Botao_texto("Detalhes",640,20,130,40,"bebas.ttf",5,pagina,detalhe_loja3,menu),
    Texto(str(variaveis.dinheiro),35,15,40,40,"bebas.ttf",pagina,(0,255,0))]
    if menu==True:
        objetos.append(Botao_texto("Voltar",20,520,150,60,"bebas.ttf",5,pagina,executar_menu_principal))
    else:
...
def executar_loja_pg4(menu):
    ...
    Botao_texto("Proximo",410,450,130,40,"bebas.ttf",5,pagina,executar_loja_pg5,menu),
    Botao_texto("Detalhes",640,20,130,40,"bebas.ttf",5,pagina,detalhe_loja4,menu),
    Texto(str(variaveis.dinheiro),35,15,40,40,"bebas.ttf",pagina,(0,255,0))]
    if menu==True:
        objetos.append(Botao_texto("Voltar",20,520,150,60,"bebas.ttf",5,pagina,executar_menu_principal))
    else:
...
def executar_loja_pg5(menu):
    ...
    Botao_texto("Proximo",410,450,130,40,"bebas.ttf",5,pagina,passar),
    Botao_texto("Detalhes",640,20,130,40,"bebas.ttf",5,pagina,detalhe_loja5,menu),
    Texto(str(variaveis.dinheiro),35,15,40,40,"bebas.ttf",pagina,(0,255,0))]
    if menu==True:
        objetos.append(Botao_texto("Voltar",20,520,150,60,"bebas.ttf",5,pagina,executar_menu_principal))
    else:
...
def executar_sobre(menu):
    pagina = Pagina((0,0,0))
    objetos = [Botao_texto("Controles",20,480,260,45,"bebas.ttf",5,pagina,executar_info_controles,True),
    Botao_texto("Projeto",20,530,200,45,"bebas.ttf",5,pagina,executar_info_projeto,True),
    Botao_texto("Voltar",620,510,160,70,"bebas.ttf",5,pagina,executar_menu_principal),
    Texto("DROMME",160,20,400,150,"fonte.ttf",pagina)]
    for i in objetos:
        pagina.lista_objetos.append(i)
    pagina.rodar_pagina()

def executar_info_controles(menu):
    pagina = Pagina((0,0,0))
    objetos = [Texto("Controles",300,20,130,45,"bebas.ttf",pagina,(255,255,255)),
    Texto("Andar   para   cima --------- w", 20,180,100,30,"bebas.ttf",pagina,(0,0,0)),
    Texto("Andar   para   baixo -------- s", 20,220,100,30,"bebas.ttf",pagina,(0,0,0)),
    Texto("Andar   para   esquerda ----- a", 20,260,100,30,"bebas.ttf",pagina,(0,0,0)),
    Texto("Andar   para   direita ------ d", 20,300,100,30,"bebas.ttf",pagina,(0,0,0)),
    Texto("Atirar ----------------- mouse1", 20,340,100,30,"bebas.ttf",pagina,(0,0,0)),
    Texto("Recarregar ------------------ r", 400,180,100,30,"bebas.ttf",pagina,(0,0,0)),
    Texto("Trocar   de   arma ---------- q", 400,220,100,30,"bebas.ttf",pagina,(0,0,0)),
    Texto("Usar   Itens ---------------- e", 400,260,100,30,"bebas.ttf",pagina,(0,0,0)),
    Texto("Suicidio -------------------- k", 400,300,100,30,"bebas.ttf",pagina,(0,0,0)),
    Texto("Pausar ---------------------- p", 400,340,100,30,"bebas.ttf",pagina,(0,0,0))]
    if menu==True:
        objetos.append(Botao_texto("Voltar",20,520,150,60,"bebas.ttf",5,pagina,executar_sobre))
    else:
        objetos.append(Botao_texto("Voltar",20,520,150,60,"bebas.ttf",5,pagina,voltar))
    for i in objetos:
        pagina.lista_objetos.append(i)
...
def executar_info_projeto(menu):
    pagina = Pagina((0,0,0))
    objetos = [Texto("Detalhes",340,20,80,45,"bebas.ttf",pagina,(255,255,255)),
    Texto("Para   saber   sobre   o   jogo,   como   ele   foi   desenvolvido   e   entrar   em   contato", 20,200,100,30,"bebas.ttf",pagina,(0,0,0)),
    Texto("Acesse:   " + variaveis.link, 20,340,100,30,"bebas.ttf",pagina,(0,0,0))]
    if menu==True:
        objetos.append(Botao_texto("Voltar",20,520,150,60,"bebas.ttf",5,pagina,executar_sobre))
    else:
        objetos.append(Botao_texto("Voltar",20,520,150,60,"bebas.ttf",5,pagina,voltar))
...
def detalhe_loja0(menu):
    pagina = Pagina((0,0,0))
    objetos = [Texto("$",10,10,20,20,"bebas.ttf",pagina,(0,255,0)),
    Texto("Dano:   " + str(variaveis.lista_armas[3].dano),10,300,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto("Dano:   " + str(variaveis.lista_armas[4].dano),275,300,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto("Dano:   " + str(variaveis.lista_armas[5].dano),540,300,40,40,"bebas.ttf",pagina,(255,255,255)),
    Botao_imagem(variaveis.lista_armas[3].imagem_lateral,10,170,250,67,10,pagina,passar),
    Botao_imagem(variaveis.lista_armas[4].imagem_lateral,275,170,250,67,10,pagina,passar),
    Botao_imagem(variaveis.lista_armas[5].imagem_lateral,540,170,250,67,10,pagina,passar),
    Texto(variaveis.lista_armas[3].raridade,10,360,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto(variaveis.lista_armas[4].raridade,275,360,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto(variaveis.lista_armas[5].raridade,540,360,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto("Disparos:  " + str(variaveis.lista_armas[3].capacidade_municao_total),10,420,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto("Disparos:  " + str(variaveis.lista_armas[4].capacidade_municao_total),275,420,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto("Disparos:  " + str(variaveis.lista_armas[5].capacidade_municao_total),540,420,40,40,"bebas.ttf",pagina,(255,255,255)),    
    Botao_texto("Loja",640,20,130,40,"bebas.ttf",5,pagina,executar_loja_pg0,menu),
    Texto(str(variaveis.dinheiro),35,15,40,40,"bebas.ttf",pagina,(0,255,0))]
    for i in objetos:
        pagina.lista_objetos.append(i)
    pagina.rodar_pagina()

def detalhe_loja1(menu):
    pagina = Pagina((0,0,0))
    objetos = [Texto("$",10,10,20,20,"bebas.ttf",pagina,(0,255,0)),
    Texto("Dano:   " + str(variaveis.lista_armas[0].dano),10,300,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto("Dano:   " + str(variaveis.lista_armas[1].dano),275,300,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto("Dano:   " + str(variaveis.lista_armas[2].dano),570,300,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto(variaveis.lista_armas[0].raridade,10,360,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto(variaveis.lista_armas[1].raridade,275,360,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto(variaveis.lista_armas[2].raridade,570,360,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto("Disparos:  " + str(variaveis.lista_armas[0].capacidade_municao_total),10,420,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto("Disparos:  " + str(variaveis.lista_armas[1].capacidade_municao_total),275,420,40,40,"bebas.ttf",pagina,(255,255,255)),
    Texto("Disparos:  " + str(variaveis.lista_armas[2].capacidade_municao_total),570,420,40,40,"bebas.ttf",pagina,(255,255,255)),
    Botao_imagem(variaveis.lista_armas[0].imagem_lateral,10,170,250,67,10,pagina,passar),
    Botao_imagem(variaveis.lista_armas[1].imagem_lateral,275,170,250,67,10,pagina,passar),
    Botao_imagem(variaveis.lista_armas[2].imagem_lateral,570,170,100,67,10,pagina,passar),
    Botao_texto("Loja",640,20,130,40,"bebas.ttf",5,pagina,executar_loja_pg1,menu),
    Texto(str(variaveis.dinheiro),35,15,40,40,"bebas.ttf",pagina,(0,255,0))]
    for i in objetos:
        pagina.lista_objetos.append(i)
    pagina.rodar_pagina()

def detalhe_loja2(menu):
    pagina = Pagina((0,0,0))
    objetos = [Texto("$",10,10,20,20,"bebas.ttf",pagina,(0,255,0)),
    Texto("Aumenta    Vida",60,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Aumenta    Municao",325,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Azolf    Guerra ",600,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Valor:   " + str(variaveis.valor_evolucao_vida),60,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Valor:   "+ str(variaveis.incremento_municao),325,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("16 anos",600,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Viciado    em    Games",600,380,40,30,"bebas.ttf",pagina,(255,255,255)),
    Botao_imagem(variaveis.imagem_kit,100,170,67,67,10,pagina,passar),
    Botao_imagem(variaveis.imagem_municao,365,170,67,67,10,pagina,passar),
    Botao_imagem(variaveis.lista_skin[0].endereco_imagem,630,170,80,80,10,pagina,passar),
    Botao_texto("Loja",640,20,130,40,"bebas.ttf",5,pagina,executar_loja_pg2,menu),
    Texto(str(variaveis.dinheiro),35,15,40,40,"bebas.ttf",pagina,(0,255,0))]
    for i in objetos:
        pagina.lista_objetos.append(i)
    pagina.rodar_pagina()

def detalhe_loja3(menu):
    pagina = Pagina((0,0,0))
    objetos = [Texto("$",10,10,20,20,"bebas.ttf",pagina,(0,255,0)),
    Texto("Donald    Tampa",60,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Acenta    Tijolo",325,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Hiro    Shima",600,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("58 Anos",60,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("12 Anos",325,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Desconhecido",600,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Ex-militar,    e    Politico",60,380,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Sonho:   ser   Youtuber",325,380,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("- Um    ninja -",600,380,40,30,"bebas.ttf",pagina,(255,255,255)),
    Botao_imagem(variaveis.lista_skin[1].endereco_imagem,100,170,67,67,10,pagina,passar),
    Botao_imagem(variaveis.lista_skin[2].endereco_imagem,365,170,67,67,10,pagina,passar),
    Botao_imagem(variaveis.lista_skin[3].endereco_imagem,630,170,80,80,10,pagina,passar),
    Botao_texto("Loja",640,20,130,40,"bebas.ttf",5,pagina,executar_loja_pg3,menu),
    Texto(str(variaveis.dinheiro),35,15,40,40,"bebas.ttf",pagina,(0,255,0))]
    for i in objetos:
        pagina.lista_objetos.append(i)
    pagina.rodar_pagina()

def detalhe_loja4(menu):
    pagina = Pagina((0,0,0))
    objetos = [Texto("$",10,10,20,20,"bebas.ttf",pagina,(0,255,0)),
    Texto("Iudy    dos   Saints",60,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Carla    Panzerspawagen",325,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Jackeline Stschek",600,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("25 Anos",60,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("28 Anos",325,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("26 Anos",600,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Ex-apresentador",60,380,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Professora    de    Alemao",325,380,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Burger Queen",600,380,40,30,"bebas.ttf",pagina,(255,255,255)),
    Botao_imagem(variaveis.lista_skin[4].endereco_imagem,100,170,67,67,10,pagina,passar),
    Botao_imagem(variaveis.lista_skin[5].endereco_imagem,365,170,67,67,10,pagina,passar),
    Botao_imagem(variaveis.lista_skin[6].endereco_imagem,630,170,80,80,10,pagina,passar),
    Botao_texto("Loja",640,20,130,40,"bebas.ttf",5,pagina,executar_loja_pg4,menu),    Texto(str(variaveis.dinheiro),35,15,40,40,"bebas.ttf",pagina,(0,255,0))]
    for i in objetos:
        pagina.lista_objetos.append(i)
    pagina.rodar_pagina()

def detalhe_loja5(menu):
    pagina = Pagina((0,0,0))
    objetos = [Texto("$",10,10,20,20,"bebas.ttf",pagina,(0,255,0)),
    Texto("Nicolau    Sergey",60,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Takamassa    Nomuro",325,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Zumbiscleison",600,300,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("38 Anos",60,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("18 Anos",325,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("24 Anos",600,340,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Ex-militar Russo",60,380,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Pedreiro    Chines",325,380,40,30,"bebas.ttf",pagina,(255,255,255)),
    Texto("Comer ...",600,380,40,30,"bebas.ttf",pagina,(255,255,255)),
    Botao_imagem(variaveis.lista_skin[7].endereco_imagem,100,170,67,67,10,pagina,passar),
    Botao_imagem(variaveis.lista_skin[8].endereco_imagem,365,170,67,67,10,pagina,passar),
    Botao_imagem(variaveis.lista_skin[9].endereco_imagem,630,170,80,80,10,pagina,passar),   Botao_texto("Loja",640,20,130,40,"bebas.ttf",5,pagina,executar_loja_pg5,menu), Texto(str(variaveis.dinheiro),35,15,40,40,"bebas.ttf",pagina,(0,255,0))]
    for i in objetos:
        pagina.lista_objetos.append(i)
    pagina.rodar_pagina()
...
def historinha6(nada):
    ...
    if nada == "fim":
        pagina = Pagina((0,0,0))
        botao_historinha = Botao_imagem("historinha6.jpeg",20,20,760,560,10,pagina,executar_menu_principal)
        pagina.lista_objetos = [botao_historinha]
        pagina.rodar_pagina()
    else:
        pagina = Pagina((0,0,0))
...
class Tela():
    ...
    def __init__(self, largura, altura, pos_x,pos_y,velocidade,mira,icone,titulo):
        self.largura = largura
        self.altura = altura
        self.velocidade = velocidade
        self.dx = 0
    ...
    def criar_tela(self):
        ...
        self.iniciar_borda_tela()

    def iniciar_borda_tela(self):
        pygame.display.set_icon(pygame.image.load(self.icone))
...
class Jogo():
            ...
            if event.type == pygame.KEYUP:
                ...
                if event.key == pygame.K_p:  
                    ...
                    while exe:
                        ...
                        texto = self.tela.fonte.render("Pausado", True, (255,255,255))
                        texto_ajuda = self.tela.fonte.render("Pressione  P  para continuar", True, (255,255,255))
                        self.tela.tela.blit(texto, (self.tela.largura//2-90,self.tela.altura//2-60))
                        self.tela.tela.blit(texto_ajuda, (self.tela.largura//2-240, self.tela.altura//2+90))
    ...
    def avancar_fase(self,nada=None):
        ...
        self.tela = copy(variaveis.objeto_tela)
        self.tela.pos_x = 0
        self.tela.pos_y = 0 
        self.tela.atualizar_dx_dy()
        self.jogador.pos_x = self.jogador.largura//2
        self.jogador.pos_y = self.jogador.altura//2
    ...
    def resetar_valores(self):
        ...
        self.jogador = copy(variaveis.objeto_jogador)
        self.jogador.vida = variaveis.vida_jogador
        self.jogador.pos_x = self.jogador.largura//2
        self.jogador.pos_y = self.jogador.altura//2
        ...
        self.mapa = copy(variaveis.objeto_mapa)

        self.fase = Fase(self.mapa,self.jogador,0)
